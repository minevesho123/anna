    ...
    >
      <div className="flex-1 flex flex-col items-start justify-center gap-[30px] min-w-[350px]">
        ...
        <div className="flex flex-row flex-wrap items-start justify-start gap-[27px] z-[0]">
          <button
            className="cursor-pointer [border:none] py-5 px-[30px] bg-buttons-primary w-[164px] rounded-39xl flex flex-row items-center justify-center box-border hover:bg-white hover:box-border hover:border-[3px] hover:border-solid hover:border-black"
            onClick={onFrameButtonClick}
          >
            <b className="relative text-lg leading-[150%] font-caption text-warm-white text-left hover:text-primary-black">
              See more
            </b>
          </button>
          <button
            className="cursor-pointer py-5 px-[30px] bg-[transparent] w-[164px] rounded-39xl box-border flex flex-row items-center justify-center border-[3px] border-solid border-buttons-primary hover:bg-buttons-primary md:hover:bg-buttons-primary"
            onClick={onFrameButton1Click}
          >
            <b
              className="relative text-lg leading-[150%] font-caption text-gray-200 text-left hover:text-oldlace"
